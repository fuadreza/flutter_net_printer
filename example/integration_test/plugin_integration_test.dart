...
void main() {
  ...
  group('Main App Integration Test', () {
    testWidgets('UI loads and shows no printers found', (WidgetTester tester) async {
      app.main();
    ...
    testWidgets('Enter IP and Port, tap Print Test and Check Device Availability', (WidgetTester tester) async {
      app.main();
      await tester.pumpAndSettle();
    ...
    testWidgets('Show snackbar for available device', (WidgetTester tester) async {
      app.main();
      await tester.pumpAndSettle();
